          ...
          <tr style={{display:"table-row"}}>
            ...
            <td className="DescribeStyle">
              <p>
                ...
                此產學合作內容，與本人之碩士論文題目相關「以壓電式感測器量測血壓之研究」，此論文題目主要為透過GRNN(廣義回歸類神經網路)來做血壓的計算。<br/>
                GRNN為使用常態分佈的概念製作出來的模型。透過常態分佈其愈接近中心點，計算出來之權重愈大的特性，計算出訓練資料以及測試資料產生之權重植，最後透過加權平均的方式，將其計算出來。
              </p>
            </td>
          </tr>
          <th style={{fontFamily: "setofont",}}>
